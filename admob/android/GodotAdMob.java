...
public class GodotAdMob extends Godot.SingletonBase {
	 ...
	 */
	public void initWithContentRating(boolean isReal, int instance_id, boolean isForChildDirectedTreatment,
	...
	/**
	 * Returns AdRequest object constructed considering the parameters set in
